                        ...
                        findAll("tr").forEach { row ->
                            ...
                            if (cells.isNotEmpty()) {
                                ...
                                val dnevni = run {
                                    ...
                                    return@run when (brojniDelovi.size) {
                                        2 -> {
                                            val stanjeText = parts.subList(0, parts.size - 2).joinToString(" ")
                                            Dnevni(
                                                stanje = stanjeText,
                                        ...
                                        1 -> {
                                            val stanjeText = parts.subList(0, parts.size - 1).joinToString(" ")
                                            Dnevni(
                                                stanje = stanjeText,
                                                prosta = brojniDelovi[0],
                                                naVoljo = null
                                ...
                                try {
                                    ...
                                    if (lokacija != null) {
                                        ...
                                        val obj = buildJsonObject {
                                            ...
                                            put("latitude", lokacija.latitude?.let { JsonPrimitive(it) } ?: JsonNull)
                                            put("longitude", lokacija.longitude?.let { JsonPrimitive(it) } ?: JsonNull)
